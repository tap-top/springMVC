...
import com.tww.service.StudentService;
...
public class StudentController {
	...
	public @ResponseBody
    Student getStudentByParamId(@RequestParam(required = true) Integer studentId) {
	...
	public @ResponseBody
    String save(@RequestBody Student jsonString) {
	...
	public @ResponseBody
    String update(@PathVariable() Integer studentId, @RequestBody Student jsonString) {
	...
	public @ResponseBody
    String patch(@PathVariable() Integer studentId, @RequestBody Student jsonString) {
		Student s = studentService.getStudentById(studentId);
    ...
    public @ResponseBody
    String removeStudent(@PathVariable("id") int id){
